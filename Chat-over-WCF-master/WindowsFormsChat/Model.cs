...
namespace WindowsFormsChat
{
    ...
    public class Model : INotifyPropertyChanged
    {
        ...
        public void SendMessage()
        {
            ...
            FillHistory(messages);
            FileStream file1 = new FileStream(@"C:\\history_message.txt", FileMode.Create);
        ...
        public List<string> GetHistoryMessages()
        {
            ...
            reader.Close();*/
            using (FileStream fstream = File.OpenRead(@"C:\\history_message.txt"))
            {
                byte[] array = new byte[fstream.Length];
                fstream.Read(array, 0, array.Length);
                string textFromFile = System.Text.Encoding.Default.GetString(array);
                messages.Add(textFromFile);
            }
            return messages;
        }
    }
